...
--
-- Host: localhost
-- Generation Time: Apr 11, 2015 at 12:57 PM
...
('Barzan Mozafari, Carlo Curino, and Samuel Madden.', 376, 160),
('', 377, 161),
('Sameer Agarwal, Barzan Mozafari, Aurojit Panda, Henry Milner, Samuel Madden and Ion Stoica', 378, 162),
('', 379, 163),
('', 380, 164),
('', 381, 165);
...
CREATE TABLE IF NOT EXISTS `publication` (
  ...
  `pj_id` int(11) NOT NULL,
  `title` text NOT NULL,
  `magzine` text NOT NULL,
  `link` text NOT NULL,
  `magzine_link` text NOT NULL,
  `info` text NOT NULL,
  `first_author` varchar(255) DEFAULT 'Barzan Mozafari',
  `pre_magzine` text NOT NULL,
  `fellow` text NOT NULL,
  PRIMARY KEY (`id`)
...
(310, 376, 'DBSeer: Resource and Performance Prediction for Building a Next Generation Database Cloud', 'CIDR', 'http://people.csail.mit.edu/barzan/papers/cidr_2013.pdf', 'http://www.cidrdb.org/cidr2013/index.html', ' Asilomar, California, USA, 2013.', 'Barzan Mozafari', 'In Proceedings of the Conference on Innovative Data Systems Research', 'Carlo Curino, Samuel Madden'),
(311, 376, 'Performance and Resource Modeling in Highly-Concurrent OLTP Workloads.', 'SIGMOD 2013 Conference', 'http://people.csail.mit.edu/barzan/papers/sigmod_2013.pdf', 'http://www.sigmod.org/2013/', ' SIGMOD 2013 Conference, New York, NY, USA, 2013', 'Barzan Mozafari ', 'Accepted to Appear In Proceedings of the ACM', 'Carlo Curino, Alekh Jindal, Samuel Madden'),
(312, 377, ' Active Learning for Crowd-Sourced Databases', 'Technical Report', 'http://web.eecs.umich.edu/~mozafari/datasets/crowdsourcing', '', 'Nov 2012.', 'Barzan Mozafari', '', 'Purnamrita Sarkar , Michael J. Franklin, Michael I. Jordan, Samuel Madden'),
(313, 377, ' Scaling Up Crowd-Sourcing to Very Large Datasets: A Case for Active Learning .', 'VLDB 2015', 'http://web.eecs.umich.edu/~mozafari/papers/vldb_2015_crowd.pdf', 'http://www.vldb.org/2015/', ' September 1-4, 2015', 'Barzan Mozafari', ' In Proceedings of the 41st International Conference on Very Large Data Bases', 'Purnamrita Sarkar, Michael J. Franklin, Michael I. Jordan, Samuel Madden'),
(314, 378, ' BlinkDB: Queries with Bounded Errors and Bounded Response Times on Very Large Data.', 'EuroSys', 'http://people.csail.mit.edu/barzan/papers/eurosys_2013.pdf', 'http://eurosys2013.tudos.org', 'Prague, Czech Republic, 2013.', 'Sameer Agarwal', 'To appear in Proceedings of the European Conference on Computer Systems', 'Barzan Mozafari, Aurojit Panda, Henry Milner, Samuel Madden, Ion Stoica'),
(315, 378, 'Blink and It''s Done: Interactive Queries on Very Large Data. ', '', 'http://people.csail.mit.edu/barzan/papers/vldb_2012.pdf', '', 'PVLDB, 5(12): 1902-1905, 2012.', 'Sameer Agarwal.', '', 'Aurojit Panda, Barzan Mozafari, Anand P. Iyer, Samuel Madden, Ion Stoica'),
(316, 379, 'K*SQL: A Unifying Engine for Sequence Patterns and XML. ', ' SIGMOD 2010 Conference', 'http://people.csail.mit.edu/barzan/papers/sigmod_2010.pdf', 'http://www.sigmod2010.org/index.shtml', 'Indianapolis, Indiana, USA, June 6-11, 2010 (SIGMOD 2010''s honorable mention demo)', 'Barzan Mozafari', 'In Proceedings of the ACM ', 'Kai Zeng, Carlo Zaniolo'),
(317, 379, ' From Regular Expressions to Nested Words: Unifying Languages and Query Execution for Relational and XML Sequences.', 'VLDB 2010', 'http://people.csail.mit.edu/barzan/papers/vldb_2010.pdf', 'http://www.vldb2010.org', 'Singapore, September 13-17, 2010.', 'Barzan Mozafari', '', 'Kai Zeng, Carlo Zaniolo'),
(318, 379, 'High-Performance Complex Event Processing over XML Streams. ', 'SIGMOD 2012 Conference', 'http://people.csail.mit.edu/barzan/papers/sigmod_2012.pdf', 'http://www.sigmod.org/2012/', 'Scottsdale, Arizona, USA, 2012. (SIGMOD 2012''s Best Paper Award)', '', ' In Proceedings of the ACM ', 'Kai Zeng, Carlo Zaniolo'),
(319, 379, 'Complex Pattern Matching in Complex Structures: the XSeq Approach ', 'ICDE 2013', 'http://people.csail.mit.edu/barzan/papers/icde_2013.pdf', 'http://www.icde2013.org', 'Brisbane, Australia, April, 2013', 'Kai Zeng', 'In Proceedings of the 29th International Conference on Data Engineering ', 'Mohan Yang, Carlo Zaniolo'),
(320, 379, 'High-Performance Complex Event Processing over Hierarchical Data. ', '', 'http://people.csail.mit.edu/barzan/papers/tods_2013.pdf', '', 'Dec, 2013.', 'Barzan Mozafari', 'To Appear In ACM TODS''s Special Issue on ''Best of SIGMOD', 'Kai Zeng, Loris D''Antoni, Carlo Zaniolo'),
(321, 380, ' Verifying and Mining Frequent Patterns from Large Windows over Data Streams.', 'ICDE 2008', 'http://people.csail.mit.edu/barzan/papers/icde_2008.pdf', 'http://www.icde2008.org', 'Cancún, Mexico, April 7-12, 2008. Download the SWIM implementation for frequent pattern/itemset mining over data streams and Download the implementation for DTV and DFV verifiers.', 'Barzan Mozafari', 'In Proceedings of the 24th International Conference on Data Engineering', 'Hetal Thakkar, Carlo Zaniolo'),
(322, 380, ' Designing an Inductive DSMS: the Stream Mill Experience.', 'EDBT 2008', 'http://people.csail.mit.edu/barzan/papers/ssps_2008.pdf', 'http://edbt2008.univ-nantes.fr', ' in conjunction with (EDBT 2008), Nantes, France, March 29, 2008.', 'Hetal Thakkar', 'In Proceedings of the 2nd International Workshop on Scalable Stream Processing Systems (SSPS 2008) in conjunction with ', 'Barzan Mozafari and Carlo Zaniolo'),
(323, 380, ' A Data Stream Mining System', 'ICDM 2008', 'http://people.csail.mit.edu/barzan/papers/icdm_2008.pdf', 'http://icdm08.isti.cnr.it', ' Pisa, Italy, December 15-19, 2008.', 'Hetal Thakkar', 'In ', 'Barzan Mozafari and Carlo Zaniolo'),
(324, 380, 'Optimal Load Shedding with Aggregates and Mining Queries.', 'ICDE 2010', 'http://people.csail.mit.edu/barzan/papers/icde_2010.pdf', 'http://www.icde2010.org', '  Long Beach, California, USA, March 1-6, 2010.', 'Barzan Mozafari.', 'In Proceedings of the 26th International Conference on Data Engineering', ' and Carlo Zaniolo'),
...
(326, 380, 'Uncertainty Propagation in Complex Query Networks on Data Streams: A New Paradigm for Load Shedding. ', '', 'http://people.csail.mit.edu/barzan/papers/uncertainty-tech.pdf', '', 'Technical Report, 120016, UCLA, 2011.', 'Kai Zeng', '', ', Barzan Mozafari, Shi Gao, and Carlo Zaniolo.'),
(327, 381, 'On the Evolution of Wikipedia', 'ICWSM 2007', ' http://people.csail.mit.edu/barzan/papers/icwsm_2007.pdf', 'http://www.icwsm.org/2007/index.html', ', Boulder, Colorado, U.S.A., March 26-28, 2007.', 'Rodrigo B. Almeida', 'In Proceedings of the International Conference on Weblogs and Social Media', ', Barzan Mozafari, Junghoo Cho.'),
(328, 381, 'Publishing Naive Bayesian Classifiers: Privacy without Accuracy Loss.', 'VLDB 2009', 'http://people.csail.mit.edu/barzan/papers/vldb_2009.pdf', 'http://vldb2009.org', ' Lyon, France, August 24-28, 2009.', 'Barzan Mozafari.', 'In Proceedings of the 35th International Conference on Very Large Data Bases', ' and Carlo Zaniolo'),
(329, 376, 'yyy', 'yyy', 'yyyyyy', 'yyy', 'yyy', 'yyy', 'yyy', 'yyy'),
(333, 376, 'lll', 'l', 'llll', 'l', 'l', 'l', 'l', 'll');
